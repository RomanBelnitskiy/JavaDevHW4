...
public class DatabaseQueryService {
    public static List<MaxSalaryWorker> findMaxSalaryWorker() {
        ...
        return Database.getInstance().executeSelect(query, DatabaseQueryService::maxSalaryWorkerMapper);
    }
    ...
    public static List<MaxProjectCountClient> findMaxProjectsClient() {
        ...
        return Database.getInstance().executeSelect(query, DatabaseQueryService::maxProjectsClientMapper);
    }
    ...
    public static List<LongestProject> findLongestProject() {
        ...
        return Database.getInstance().executeSelect(query, DatabaseQueryService::longestProjectMapper);
    }
    ...
    public static List<YoungestEldestWorker> findYoungestEldestWorkers() {
        ...
        return Database.getInstance().executeSelect(query, DatabaseQueryService::youngestEldestWorkersMapper);
    }
    ...
    public static List<ProjectPrice> findProjectPrices() {
        ...
        return Database.getInstance().executeSelect(query, DatabaseQueryService::projectPricesMapper);
    }
